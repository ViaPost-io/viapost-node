...
npm install @viapost-io/sdk@0.4.0
```
...
```bash
npm install https://github.com/ViaPost-io/viapost-node/releases/download/v0.4.0/viapost-sdk-0.4.0.tgz
```
...
The v0.4.0 snapshot has SHA-256
