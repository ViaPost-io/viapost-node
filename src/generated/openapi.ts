...
export interface paths {
    ...
    readonly "/v1/domains/{domain_id}/tracking-domains": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        readonly get: operations["getDomainTrackingDomains"];
        readonly put?: never;
        /** Reservar domínio de tracking */
        readonly post: operations["postDomainTrackingDomains"];
        readonly delete?: never;
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
    ...
    readonly "/v1/domains/{domain_id}/tracking-domains/{tracking_domain_id}": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        readonly get: operations["getDomainTrackingDomain"];
        readonly put?: never;
        readonly post?: never;
        readonly delete?: never;
        readonly options?: never;
    ...
    readonly "/v1/domains/{domain_id}/tracking-domains/{tracking_domain_id}/verify": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        readonly post: operations["postDomainTrackingDomainVerify"];
        readonly delete?: never;
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
    ...
    readonly "/v1/domains/{domain_id}/tracking-domains/{tracking_domain_id}/activate": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        readonly post: operations["postDomainTrackingDomainActivate"];
        readonly delete?: never;
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
    ...
    readonly "/v1/domains/{domain_id}/tracking-domains/{tracking_domain_id}/revoke": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        readonly post: operations["postDomainTrackingDomainRevoke"];
        readonly delete?: never;
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
    ...
    readonly "/v1/domains/{domain_id}/tracking-domains/{tracking_domain_id}/proof/rotate": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        readonly post: operations["postDomainTrackingDomainProofRotate"];
        readonly delete?: never;
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
...
export interface components {
    schemas: {
        ...
        readonly CreateTrackingDomainRequest: {
            /** @description Hostname DNS, canonicalizado para ASCII/IDNA. */
            readonly hostname: string;
        };
        readonly TrackingDomain: {
            readonly id: components["schemas"]["UUID"];
            readonly hostname: string;
            /** @enum {string} */
            readonly state: "pending_proof" | "verified" | "provisioning" | "active" | "suspended" | "revoked";
            readonly proof_expires_at: components["schemas"]["Timestamp"] | null;
            readonly proof_verified_at: components["schemas"]["Timestamp"] | null;
            readonly last_checked_at: components["schemas"]["Timestamp"] | null;
            readonly activated_at: components["schemas"]["Timestamp"] | null;
            readonly suspended_at: components["schemas"]["Timestamp"] | null;
            readonly revoked_at: components["schemas"]["Timestamp"] | null;
            readonly created_at: components["schemas"]["Timestamp"];
            readonly updated_at: components["schemas"]["Timestamp"];
        };
        readonly TrackingDomainList: {
            readonly tracking_domains: readonly components["schemas"]["TrackingDomain"][];
        };
        readonly TrackingDomainResponse: {
            readonly tracking_domain: components["schemas"]["TrackingDomain"];
        };
        readonly TrackingDomainProofResponse: {
            readonly tracking_domain: components["schemas"]["TrackingDomain"];
            readonly proof: {
                /** @constant */
                readonly type: "TXT";
                readonly name: string;
                /** @description Valor retornado somente nas respostas de reserva e rotação; nunca em leituras. */
...
export interface operations {
    ...
    readonly getDomainTrackingDomains: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
        ...
        readonly responses: {
            ...
            readonly 200: {
                ...
                content: {
                    readonly "application/json": components["schemas"]["TrackingDomainList"];
                };
            };
            readonly 404: components["responses"]["NotFound"];
        };
    };
    readonly postDomainTrackingDomains: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
        ...
        readonly requestBody: {
            readonly content: {
                readonly "application/json": components["schemas"]["CreateTrackingDomainRequest"];
            };
        };
        readonly responses: {
            /** @description Reserva criada; a prova só aparece nesta resposta */
            readonly 201: {
                headers: {
                    readonly "Cache-Control"?: "private, no-store";
                    readonly [name: string]: unknown;
                ...
                content: {
                    readonly "application/json": components["schemas"]["TrackingDomainProofResponse"];
                };
            };
            readonly 400: components["responses"]["ValidationError"];
            readonly 404: components["responses"]["NotFound"];
    ...
    readonly getDomainTrackingDomain: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
                readonly domain_id: string;
                readonly tracking_domain_id: string;
            };
            readonly cookie?: never;
        };
        readonly requestBody?: never;
        readonly responses: {
            ...
            readonly 200: {
                ...
                content: {
                    readonly "application/json": components["schemas"]["TrackingDomainResponse"];
                };
            };
            readonly 404: components["responses"]["NotFound"];
        };
    };
    readonly postDomainTrackingDomainVerify: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
    ...
    readonly postDomainTrackingDomainActivate: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
        ...
        readonly requestBody?: never;
        readonly responses: {
            /** @description Provisionamento solicitado */
            readonly 202: {
                headers: {
                    readonly [name: string]: unknown;
                };
    ...
    readonly postDomainTrackingDomainRevoke: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
    ...
    readonly postDomainTrackingDomainProofRotate: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
